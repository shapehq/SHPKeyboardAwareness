...
- (instancetype _Nonnull)initWithDelegate: (id<SHPKeyboardAwarenessClient> _Nullable) delegate;
- (instancetype _Nonnull)initWithObserveView: (UIView *_Nullable)view delegate: (id<SHPKeyboardAwarenessClient> _Nullable) delegate;
...
+ (instancetype _Nonnull)Observe;
+ (instancetype _Nonnull)ObserveWithDelegate: (id<SHPKeyboardAwarenessClient> _Nullable) delegate;
/// The receiver will get keyboard events during its life time. The receiver must implement the keyboardTriggeredEvent: method as defined
...
+ (instancetype _Nonnull)ObserveView: (UIView *_Nullable)view;
+ (instancetype _Nonnull)ObserveView: (UIView *_Nullable)view withDelegate: (id<SHPKeyboardAwarenessClient> _Nullable) delegate;
